function save_shuffled_models(shuffled_models,params)
model_collection.models = shuffled_models;
filename = strcat(params.source_directory, '/expt/', params.name, '/', 'fulldata.mat');
...
save(filename,'F','G','node_pot','edge_pot',...
