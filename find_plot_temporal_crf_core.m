function [results] = find_plot_temporal_crf_core(best_model,shuffle_model,data,UDF, coords)
...
%       Neurons by coordinates.
    ...
    [~, results] = find_temporal_ens_nodes(best_model, shuffle_model, data, UDF, num_controls);
    ...
    for ii = 1:num_stim
        ...
        plot((shuffle_model.mepsum-(2*shuffle_model.sdepsum))*[1 1],[aucmi aucma],'--',...
            'color',0.7*[1 1 1]);
        ...
        title(['High-Ranking Nodes for UDF' num2str(ii)])
