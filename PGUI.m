classdef PGUI < matlab.apps.AppBase
    ...
    properties (Access = public)
        params = struct('p_lambda_count',2,'p_lambda_min',10,'p_lambda_max', 10000,'edges','simple','no_same_neuron_edges',1,'reweight_denominator',...
            ...
            'BCFW_fval_epsilon',0.1,'printInterval',1000,'printTest',100,'MaxTime',Inf,'num_structures',8,'logspace',1);
    end
    ...
    methods (Access = private)
        ...
        % Value changed function: P_range
        ...
        function ChangeModel(app, event)
            ...
            app.TotalNumberofModelsEditField.Value = prange*numstruct;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.RangeEditField_2Label.Position = [51 265 47 22];
            app.RangeEditField_2Label.Text = 'Range';

            % Create P_range
            app.P_range = uieditfield(app.UIFigure, 'numeric');
            app.P_range.Limits = [0 Inf];
            app.P_range.ValueChangedFcn = createCallbackFcn(app, @P_rangeValueChanged, true);
            app.P_range.FontName = 'Palatino';
            app.P_range.Position = [107 265 314 22];
            ...
            app.MinEditField_2Label.Position = [55 225 47 22];
            ...
            app.P_max.Position = [107 187 314 22];
            ...
            app.MaxIterationsEditFieldLabel.Position = [541 305 81 22];
            ...
            app.PrintTestEditField.Position = [661 185 290 22];
            ...
            app.PrintDualityGapEditFieldLabel.Position = [541 145 96 22];
            ...
            app.PrintDualityGapEditField.Position = [661 145 290 22];
            ...
            app.ContinueButton_2.Position = [721 45 100 22];
            ...
            app.BlockCoordinateFrankeWolfeLabel.Position = [541 345 375 22];
            ...
            app.MaxTimeEditField_2Label.Position = [541 105 58 22];
            ...
            app.MaxTimeEditField_2.Position = [661 105 290 22];
